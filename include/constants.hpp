...
constexpr const char APP_FILENAME[] =               "/config/switchbros-updater/sbu.zip";
...
constexpr const char CFW_FILENAME[] =               "/config/switchbros-updater/sbos.zip";
constexpr const char BOOTLOADER_FILENAME[] =        "/config/switchbros-updater/sbos.zip";

constexpr const char AMS_FILENAME[] =               "/config/switchbros-updater/sbos.zip";
